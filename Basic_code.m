...
for i=1:no_frames-1
    ...
    %imshow(grayframe);
    [dif,fbG] = removeBackgroundGrayscale(backgroundG,frameG,32);
...
[peaks time] = findpeaks(heightsFiltered);
...
%{
vLines = findLocalMinima(heightsFiltered);
for i = 1:1:finalFrame-firstFrame
    if vLines(i) == 1
        vline(firstFrame + i -1);
    end
end
%}